...
(function() {
  ...
  module.exports = Server = (function() {
    ...
    Server.prototype._requestAllowed = function(request) {
      var allowMatched, normalizedPath, normalizedQuery, normalizedUri, pattern, uriParts, _i, _j, _len, _len1, _ref, _ref1;
      uriParts = url.parse(request.url);
      normalizedPath = encodeURIComponent(decodeURIComponent(uriParts.pathname));
      normalizedQuery = querystring.stringify(querystring.parse(uriParts.query));
      normalizedUri = util.format('%s?%s', normalizedPath, normalizedQuery);
